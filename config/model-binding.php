...
'agendacalendarevent' => function ($value) {
        return NextDeveloper\Agenda\Database\Models\AgendaCalendarEvent::findByRef($value);
},
...
'agendacalendareventattendee' => function ($value) {
        return NextDeveloper\Agenda\Database\Models\AgendaCalendarEventAttendee::findByRef($value);
},
