...
class CalendarEventsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Agenda\CalendarEvents', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Agenda\CalendarEvents', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Agenda\CalendarEvents', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Agenda\CalendarEvents', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Agenda\CalendarEvents', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Agenda\CalendarEvents', $model);
    }
