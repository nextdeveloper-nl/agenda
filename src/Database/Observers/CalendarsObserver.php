...
class CalendarsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Agenda\Calendars', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Agenda\Calendars', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Agenda\Calendars', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Agenda\Calendars', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Agenda\Calendars', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Agenda\Calendars', $model);
    }
