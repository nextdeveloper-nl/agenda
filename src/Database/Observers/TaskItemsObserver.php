...
class TaskItemsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Agenda\TaskItems', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Agenda\TaskItems', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Agenda\TaskItems', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Agenda\TaskItems', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Agenda\TaskItems', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Agenda\TaskItems', $model);
    }
