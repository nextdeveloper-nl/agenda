...
/**
 * Class CalendarSubscriptionsObserver
 *
...
class CalendarSubscriptionsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Agenda\CalendarSubscriptions', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Agenda\CalendarSubscriptions', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Agenda\CalendarSubscriptions', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Agenda\CalendarSubscriptions', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Agenda\CalendarSubscriptions', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Agenda\CalendarSubscriptions', $model);
    }
