...
class ContactsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Agenda\Contacts', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Agenda\Contacts', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Agenda\Contacts', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Agenda\Contacts', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Agenda\Contacts', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Agenda\Contacts', $model);
    }
