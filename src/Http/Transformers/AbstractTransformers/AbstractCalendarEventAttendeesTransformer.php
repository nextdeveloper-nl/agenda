...
class AbstractCalendarEventAttendeesTransformer extends AbstractTransformer
{
    ...
    {
                                                $calendarEventId = \NextDeveloper\\Database\Models\CalendarEvents::where('id', $model->calendar_event_id)->first();
        ...
        return $this->buildPayload(
            ...
            'calendar_event_id'  =>  $calendarEventId ? $calendarEventId->uuid : null,
