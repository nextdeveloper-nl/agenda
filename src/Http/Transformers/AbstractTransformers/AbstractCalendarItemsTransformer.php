...
class AbstractCalendarItemsTransformer extends AbstractTransformer
{
    ...
    public function includeStates(CalendarItems $model)
    {
    ...
    public function includeActions(CalendarItems $model)
    {
    ...
    public function includeMedia(CalendarItems $model)
    {
    ...
    public function includeSocialMedia(CalendarItems $model)
    {
    ...
    public function includeComments(CalendarItems $model)
    {
    ...
    public function includeVotes(CalendarItems $model)
    {
    ...
    public function includeMeta(CalendarItems $model)
    {
    ...
    public function includePhoneNumbers(CalendarItems $model)
    {
    ...
    public function includeAddresses(CalendarItems $model)
    {
