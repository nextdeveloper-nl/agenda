...
class AbstractAllContactsTransformer extends AbstractTransformer
{
    ...
    public function includeStates(AllContacts $model)
    {
    ...
    public function includeActions(AllContacts $model)
    {
    ...
    public function includeMedia(AllContacts $model)
    {
    ...
    public function includeSocialMedia(AllContacts $model)
    {
    ...
    public function includeComments(AllContacts $model)
    {
    ...
    public function includeVotes(AllContacts $model)
    {
    ...
    public function includeMeta(AllContacts $model)
    {
    ...
    public function includePhoneNumbers(AllContacts $model)
    {
    ...
    public function includeAddresses(AllContacts $model)
    {
