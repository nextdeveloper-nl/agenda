...
class AbstractCalendarSubscriptionsTransformer extends AbstractTransformer
{
    ...
    public function includeStates(CalendarSubscriptions $model)
    {
    ...
    public function includeActions(CalendarSubscriptions $model)
    {
    ...
    public function includeMedia(CalendarSubscriptions $model)
    {
    ...
    public function includeSocialMedia(CalendarSubscriptions $model)
    {
    ...
    public function includeComments(CalendarSubscriptions $model)
    {
    ...
    public function includeVotes(CalendarSubscriptions $model)
    {
    ...
    public function includeMeta(CalendarSubscriptions $model)
    {
    ...
    public function includePhoneNumbers(CalendarSubscriptions $model)
    {
    ...
    public function includeAddresses(CalendarSubscriptions $model)
    {
