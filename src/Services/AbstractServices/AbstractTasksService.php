...
use NextDeveloper\Agenda\Database\Filters\TasksQueryFilter;
...
class AbstractTasksService
{
     ...
     * @return mixed
     */
    public static function getByRef($ref) : ?Tasks
    {
        return Tasks::findByRef($ref);
    }
    ...
    {
        $object = Tasks::where('uuid', $objectId)->first();
     ...
     * @return Tasks|null
     */
    public static function getById($id) : ?Tasks
    {
    ...
    {
        try {
            $obj = Tasks::where('uuid', $uuid)->first();
     ...
     * @return Tasks
     */
    public static function updateRaw(array $data) : ?Tasks
    {
